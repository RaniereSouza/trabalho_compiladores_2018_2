#****************************************************************#
# Makefile Compilador (Parser/Semantic Analyzer)                 #
# Trabalho 2 da disciplina MATA61 - Compiladores - 2018.2        #
# Analisador Sintático/Semântico (Parser) em C++ e Bison (3.0.4) #
...
YYFILES         = compiler_parser.tab.cpp compiler_parser.tab.hpp #GENERATED BY BISON
CC              = g++ #COMPILER
...
compiler:                                                   clean $(YYFILES) compiler_scanner.cpp compiler_main.cpp
	                                                        $(CC) $(CFLAGS) $(COMP_SOURCES) -o $(COMP_OUTPUT)

$(YYFILES):                                                 compiler_parser.ypp
	                                                        bison $(BISON_FLAGS) $(BISON_SOURCE)

compiler_scanner.cpp compiler_parser.ypp compiler_main.cpp: compiler_headings.hpp
